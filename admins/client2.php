...
<section id="containerColumn" class="container-fluid">
    ...
    <div class="column-1">
        ...
        <form id="form" class="form" method="post" action="client1.php">
            <input type="hidden" name="clientId" value="<?php echo @$_GET['clientId'] ?>">
            <label for="nameInput">Digite o nome do cliente:</label>
            <input autofocus type="text" id="nameInput" class="rt-text-input select-disable" name="clientName" maxlength="60" placeholder="">
            <p class="error-text">Informe o nome do cliente.</p>
            <label for="emailInput">Digite o endereço de e-mail do cliente:</label>
            <input type="text" id="emailInput" class="rt-text-input select-disable" name="clientEmail" maxlength="60" placeholder="">
            <p class="error-text">Endereço de e-mail inválido.</p>
            <label for="phoneInput">Digite o número de contato do cliente:</label>
            <input type="text" id="phoneInput" class="rt-text-input select-disable" name="clientPhone" maxlength="15" placeholder="">
                            ...
                            <div id="editClientModal" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <form id="formModal" method="post" action="client1.php">
...
<script src="../ativos/js/client.js"></script>
</body>
